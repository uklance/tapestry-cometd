...
public class CometdHttpServletRequestFilter extends ServletHttpServletRequestFilter implements
	...
	public CometdHttpServletRequestFilter(ApplicationGlobals applicationGlobals,
			Map<String, String> initParams, RegistryShutdownHub registryShutdownHub,
			@Symbol("cometd.uriPattern") String uriPattern) {
		super(applicationGlobals, createServletFactory(initParams), registryShutdownHub, uriPattern);
		this.bayeuxServer = (BayeuxServer) applicationGlobals.getServletContext().getAttribute(
